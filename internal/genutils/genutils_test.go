...
func TestWriteFS(t *testing.T) {
	fs := fstest.MapFS{
		"foo.go": {Mode: 0666, Data: []byte("// Code generated by xxx; DO NOT EDIT.\n\npackage main\n")},
		"bar.go": {Mode: 0666, Data: []byte("// Code generated by yyy; DO NOT EDIT.\n\npackage main\n")},
	}
	if err := fstest.TestFS(fs, "foo.go", "bar.go"); err != nil {
		t.Fatal(err)
	}
	...
	if err := fstest.TestFS(outDir.FS(), "foo.go", "bar.go"); err != nil {
		t.Fatal(err)
	}
}
